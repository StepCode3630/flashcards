...
docker compose up -d
```
> *Note : Attendez environ 10-15 secondes lors du premier lancement pour que MySQL initialise la base.*
...
```
*(Où `db` correspond au nom du service MySQL dans votre `docker-compose.yml`)*
